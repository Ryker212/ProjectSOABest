...
public interface OrdersRepository extends CrudRepository<Orders, Integer>{
	 @Query(nativeQuery = true,value = "SELECT o.id as order_id, p.name as package_name, p.price as package_price, p.wash as package_wash, p.dry as package_dry, fs.name as softener_name, fs.price as softener_price, wt.name as temp_name,  o.plusdry as order_plusdry, u.username as username, o.status as order_status, e3.name as reciever_name, e2.name as sender_name, e1.name as checker_name FROM orders AS o\r\n"
